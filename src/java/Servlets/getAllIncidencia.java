 ...
 * @author uryy9
 */
@WebServlet(name = "getAllIncidencia", urlPatterns = {"/getAllIncidencia"})
public class getAllIncidencia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet getAllIncidencia</title>");
